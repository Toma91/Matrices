...
@_inlineable
public func /<T: BinaryFloatingPoint>(lhs: ColumnVector<T>, rhs: ColumnVector<T>) -> ColumnVector<T> {
...
@_inlineable
public func /<T: BinaryFloatingPoint>(lhs: RowVector<T>, rhs: RowVector<T>) -> RowVector<T> {
    precondition(lhs.length == rhs.length)
