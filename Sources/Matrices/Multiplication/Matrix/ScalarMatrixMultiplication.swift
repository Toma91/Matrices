//
//  ScalarMatrixMultiplication.swift
//  Matrices
//
//  Created by Andrea Tomarelli on 01/01/18.
//

public struct ScalarMatrixMultiplication<T: Numeric> {
...
public extension ScalarMatrixMultiplication {
...
extension ScalarMatrixMultiplication {
